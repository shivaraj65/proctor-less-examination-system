            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6 text-center">
                        <div className="mt-5">
                            <i className="fas fa-4x fa-gem text-warning mb-4"></i>
                            <h3 className="h4 mb-2">Built like a Diamond</h3>
                            <p className="text-muted mb-0">Made to survive on any situation</p>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 text-center">
                        <div className="mt-5">
                            <i className="fas fa-4x fa-laptop-code text-success mb-4"></i>
                    ...
                    <div className="col-lg-3 col-md-6 text-center">
                        <div className="mt-5">
                            <i className="fas fa-4x fa-heart text-danger mb-4"></i>
